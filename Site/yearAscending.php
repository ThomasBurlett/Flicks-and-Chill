...
echo '<div class="container-fluid">
            ...
            <div class="dropdown" style="float:right">
                <button aria-expanded="true" aria-haspopup="true" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="dropdownMenu1" type="button">Year Ascending <span class="caret"></span></button>
